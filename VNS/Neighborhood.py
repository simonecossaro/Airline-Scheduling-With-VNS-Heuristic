            ...
            if (n1 != n2):
                for u in range(1,len(P[n1])-1):
                    for v in range(1,len(P[n2])-1):
                        if (self.con(P[n1][u-1],P[n2][v]) and self.con(P[n2][v],P[n1][u+1]) and self.con(P[n2][v-1],P[n1][u]) 
                            and self.con(P[n1][u],P[n2][v+1])):
                            P2 = P
                            P2[n1][u] = P[n2][v]
                            P2[n2][v] = P[n1][u]
                            return P2
